...
const FilterInfoTitle = ({ filterType, filterDates, onClear }) => {
    const DateRangeChip = ({ date }) => {
        const startDate = date?.from ? moment(date.from).format("Do MMMM YYYY") : "N/A";
        const endDate = date?.to ? moment(date.to).format("Do MMMM YYYY") : "N/A";
        ...
        return (
            <div className="flex items-center gap-2 bg-state-100 px-3 py-2 rounded">
